...
public class Homework2 {
    ...
    public static void ex1() {
        ...
        int k = arrayOfNumbers.length - 1;

        for (int i = 0; i < arrayOfNumbers.length; i++) {
            leftUpToRightDownSum += arrayOfNumbers[i][i];
            leftDownToRightUpSum += arrayOfNumbers[i][k];
            k--;
        }

        System.out.printf("leftUpToRightDownSum: %d\n", leftUpToRightDownSum);
        System.out.printf("leftDownToRightUpSum: %d\n", leftDownToRightUpSum);
    }

    public static void ex2() {
        //Перевернуть массив(без сторонних классов), не создавая новый массив
    ...
    public static void ex3() {
        //генерация случайных чисел до тех пор, пока не сгенерируется 999.
        ...
        System.out.println("номер попытки: " + counter);
    }
